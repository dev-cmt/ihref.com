    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="{{route('page.director-members')}}">পরিচালক ও সদস্য</a></li>
                <li class="nav-item"><a class="nav-link" href="{{route('page.committee-members')}}">কমিটি</a></li>
